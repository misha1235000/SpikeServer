...
**Showing support for serverregisterserver**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for serverregisterserver:

- star the [project](https://github.com/misha1235000/serverRegisterServer#readme)
- tweet your support for serverregisterserver
...
- **version**: (required) please note the version of serverregisterserver are you using
...
The original poster or the maintainers of serverregisterserver may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/serverregisterserver
